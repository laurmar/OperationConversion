...
/**
 * This class is designed to assist in ensuring that the addition symbol is put in
...
public class Plus implements Token, Operator {
    ...
    /**
     * This is the template for a new Plus object
     */
    public Plus(){
    ...
    /**
     * @return the symbol that represents a Plus
     */
     ...
     *
     * In this case we remove some operators and then push a Plus object onto the stack
    ...
    /**
     * This looks at precedences of operators to see how they compare to Plus
     * @param item current item to be evaluated
