...
/**
 * This class is designed to assist in ensuring that the multiplication symbol is put in
...
public class Multiply implements Token, Operator {
    ...
    /**
     * This is the template for a new Multiply object
     */
    public Multiply(){
     ...
     *
     * In this case we remove some operators and then push a multiply object onto the stack
    ...
    /**
     * This looks at precedences of operators to see how they compare to Multiply
     * @param item current item to be evaluated
